const { sumNumberFindTarger } = require("./");
...
test("1. should return true", function () {
  const result = sumNumberFindTarger([1,2,3,4,5], 9);
  expect(result).toEqual(true);
});
test("2. should return false", function () {
  const result = sumNumberFindTarger([1,2,3,4,5], 8);
  expect(result).toEqual(false);
});
test("3. should return true", function () {
  const result = sumNumberFindTarger([11,9,7,5,3,2], 9);
  expect(result).toEqual(true);
});
test("4. should return false", function () {
  const result = sumNumberFindTarger([11,9,7,5,3,2], 22);
  expect(result).toEqual(false);
});
test("5. should return true", function () {
  const result = sumNumberFindTarger([5,1,3,8,10], 11);
  expect(result).toEqual(true);
});
test("6. should return false", function () {
  const result = sumNumberFindTarger([5,1,3,8,10], 7);
  expect(result).toEqual(false);
});
